    ...
    return (
      <form>
        <div className='sign-up-form'>
          ...
          <label className='sign-up-form__label sign-up-form__email-label' htmlFor='sign-up-email'>
            E-mail
            <input type='text' className='sign-up-form__input sign-up-form__email' id='sign-up-email' />
          </label>
          ...
          <label className='sign-up-form__label sign-up-form__pass-label' htmlFor='sign-up-confirm-pass'>
            Confirm Password
            <input type='password' className='sign-up-form__input sign-up-form__pass' id='sign-up-confirm-pass' autoComplete='on' />
          </label>
