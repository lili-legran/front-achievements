...
function JSIcon() {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' className='skill__button_icon' viewBox='0 0 32 32' width='32' height='32' fill='rgb(49, 49, 49' style={{ backgroundColor: '#f5de19', borderRadius: '20%' }}>
      <title>js-icon</title>
