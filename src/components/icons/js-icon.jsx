...
function JSIcon() { 
    return (
      ...
      <svg xmlns="http://www.w3.org/2000/svg" className='skill-button__icon' viewBox="0 0 32 32" width="32" height="32" fill="#f5de19" style={ {backgroundColor: 'rgb(49, 49, 49', borderRadius: '20%'} }>
        <title>js-icon</title>
